...
Native Android educational project demonstrating SQLite database and local data persistence, developed as part of the Mobile App Development curriculum.
...
``bash
git clone https://github.com/DiaztMF/projectEnam-android.git
cd projectEnam-android
``
...
$rName is a focused Android development assignment created to master foundational mobile engineering patterns. It explores SQLite database and local data persistence through clean Android architecture guidelines.

## Why 

Mastering native Android development requires solid understanding of core framework components, UI lifecycles, and threading boundaries. This project provides hands-on practical implementation of SQLite database and local data persistence without third-party abstraction overhead.
...
protected void onCreate(Bundle savedInstanceState) {
    ...
    Log.d("projectEnam-android", "Activity initialized successfully");
}
``
